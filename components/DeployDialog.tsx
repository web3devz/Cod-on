        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[800px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                    Are you ready to deploy your smart contract? Just click the button below to deploy it.
                        {}
                    </DialogDescription>
                </DialogHeader>
                {loading ? (
                    ...
                    <div className="flex flex-row items-center gap-4">
                        <div className="sm:max-w-[500px] truncate font-mono"
                        ...
                        <Button
                            ...
                            onClick={() => {
                                // open the explorer
                                window.open(
                                    `https://testnet.aescan.io/contracts/${address}`,
                                    "_blank"
                                );
